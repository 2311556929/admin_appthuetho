...
const FormUpdareProduct = ({ visible, product, Cancel, fetchResetApi, edit }) => {
        ...
        <CModalBody>
          ...
          <CCardBody>
            <CForm>
              <CRow>
                <CCol sm={6}>
                  <CCard className="mt-2 mb-2 " sm={12}>
                    <CCardBody className="d-flex align-items-center gap-3">
                      ...
                      <div>
                        <CCardTitle className="fw-bold">
                          Khách hàng : <span className="fw-normal">Nguyễn Duy Tân</span>
                        </CCardTitle>
                  ...
                  <CRow>
                    <CCol sm={12}>
                      <CCard className="mt-2">
                        <CCardHeader className="fw-bold fs-5">Cuộc hội thoại</CCardHeader>

                        <CCardBody className="d-flex flex-column">
                          <div className="flex-grow-1 overflow-auto mb-2">
                            {/* Khách */}
                            <div className="d-flex flex-column mb-3 align-items-start">
                              <small className="text-muted mb-1 fw-semibold ">
                                Khách - Duy Tân
                              </small>
                              <div className="bg-light text-dark p-2 rounded shadow-sm chat-bubble">
                                sửa lâu ko anh trai?
                              </div>
                            </div>
