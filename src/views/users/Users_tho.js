...
import FormUpdareUser_tho from './FormUpdateUser_tho.js'
          ...
          <CTable bordered striped hover className="text-center align-middle">
            <CTableHead color="dark" className="fs-6">
              <CTableRow>
                ...
                <CTableHeaderCell scope="col">Tên Thợ</CTableHeaderCell>
                <CTableHeaderCell scope="col">Địa chỉ cửa hàng</CTableHeaderCell>
              ...
              <CTableRow>
                ...
                <CTableDataCell>
                  <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                    ...
                    <CButton color="danger" onClick={() => clickDeleteUserById()}>
                      <CIcon icon={cilTrash} />
                    </CButton>
                  </div>
                </CTableDataCell>
